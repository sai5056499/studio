...
import { Settings, User, Shield, Moon, Sun, Monitor, Smartphone, Database, Download, Upload, Trash2, Save, X, Check, Send, ArrowUp, ArrowDown, RotateCcw } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const [sidebarItems, setSidebarItems] = useState<NavItem[]>(defaultNavItems);
  ...
  const handleExportData = () => {
    ...
    a.href = url;
    a.download = `studio-backup-${new Date().toISOString().split('T')[0]}.json`;
